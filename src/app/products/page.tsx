...
const trubathProducts = [
  ...
  },
  {
    ...
    image: "/truwall-config-statuario.jpg",
    fit: "contain",
  },
  {
  ...
  },
  {
    ...
    description:
      "Tile-in drain assembly finished in matte black, designed to sit flush within the shower base for a clean, low-profile detail.",
    specs: ["Tile-in top plate", "Matte black finish"],
    image: "/flofx-drain-black.jpg",
    fit: "contain",
  },
  {
  ...
  },
  {
    name: "Custom Bench",
    description:
      "Solid porcelain shower bench color-matched to the wall panels, for a built-in seat that reads as part of the surround rather than an add-on.",
    specs: ["Solid porcelain construction", "Color-matched to wall panels", "All four finishes"],
    image: "/bench-calacatta.jpg",
    fit: "contain",
  },
  {
    name: "TRUtrim Window",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {trubathProducts.map((product) => (
              <div
                key={product.name}
                className="group flex flex-col rounded-[24px] overflow-hidden bg-ivory ring-1 ring-stone-200/80 hover:shadow-luxury transition-all duration-500 hover:-translate-y-1"
              >
                <div className="aspect-square overflow-hidden bg-white">
                  <Image
                    ...
                    className={`w-full h-full transition-transform duration-[1200ms] ease-out ${
                      product.fit === "contain"
                        ? "object-contain p-8 group-hover:scale-[1.04]"
                ...
                <div className="flex flex-1 flex-col p-7">
                  ...
                  <Link
                    href="/contact"
                    className="mt-auto inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-primary hover:text-primary-light transition-colors"
                  >
                    Inquire Now
